...
d3.json('../../files/pubs.json', function(err, d) {
  ...
  pubs = d.filter(function(d) { return d.Key === "brown2014finding"; });
  console.log(pubs);
  buildDivs(pubs);
});

/*
 * Author: "Eli Brown, Alvitta Ottley, Jieqiong Zhao, Quan Lin, Alex Endert, Richard Souvenir, Remco Chang"
 * Category: "Conference"
 * Journal: "To Appear: IEEE Conference on Visual Analytics (VAST)"
 * Key: "brown2014finding"
 * Title: "Finding Waldo: Learning about Users from their Interactions"
 * Year: "2014"
 * abstract: "..."
 * img: "img/preview/brown2014finding-preview.png"
...
function abstract() {
  ...
  el.append('div')
    .text(function(d) { return d.abstract; });
}
